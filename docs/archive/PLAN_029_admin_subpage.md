...
### Task 1: AdminPage + `/admin` route with admin guard [DONE]
...
### Task 2: Relocate panels out of ProfilePage + add admin link [DONE]
...
### Task 3: Show "last seen" in UserApprovalPanel [DONE]
